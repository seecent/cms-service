...
viableleads = Table('lms_viable_leads', Base.metadata,
    ...
    Column('contact_id', None, ForeignKey('lms_viable_contacts.id')),
...
Index('idx_lms_viableleads_created_date', viableleads.c.created_date)

viablecontacts = Table('lms_viable_contacts', Base.metadata,
   Column('id', BigInteger, primary_key=True, autoincrement=False),
    Column('no', Integer, default=0),
    Column('collection_id', None, ForeignKey('lms_collections.id')),
    ...
    # Column('company_id', None, ForeignKey('contact_company.id')),
    Column('created_date', DateTime, nullable=False)
)
