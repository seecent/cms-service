...
_default = {
    ...
    "sqlalchemy.url": "postgresql://lms:lms_line@localhost/lmsdb",
...
dataSources = {
    "lmsdb": {"username": "lms",                       # lmsdb数据库用户名
              ...
              "type": "postgresql",                    # lmsdb数据库类型
              "host": "localhost",                     # lmsdb数据库服务器域名或IP
              "port": 5432,                            # lmsdb数据库端口
    ...
    "campaigndb": {"username": "lms",                       # campaigndb数据库用户名
                   ...
                   "database": "lmsdb",                     # campaigndb数据库名称
